...
<form class="text-center border border-light p-5" method="post"
    ...
    <input type="text" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="Registration No." name="registrationno">


    <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="Password" name="pswd">
