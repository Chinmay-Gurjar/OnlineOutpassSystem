        ...
        <form class="text-center border border-light p-5" method="post" action="../connection/leave-submit.php">
            ...
            <div class="form-row mb-4">
                ...
                <div class="col">
                    ...
                    <input type="date" id="date" name="from" class="form-control mb-4" placeholder="Date" style="position: relative; left: 170px; width: 250px;">
                </div>
                <div class="col">
                    <span style="position: absolute; left: 10px; font-weight: 700; top: 8px;">To : </span>
                    <input type="date" id="date" name="to" class="form-control mb-4" placeholder="Date" style="position: relative; left: 170px; width: 250px;">                    
                </div>
            </div>
            ...
            <div class="form-row mb-4">    
                <div class="col" style="top:-16px;">
                    ...
                    <input type="text" id="contactnumber" name="studentcontact" class="form-control" placeholder="Contact No." style="position: relative; left: 170px; width: 250px;">
                </div>
                <div class="col" style="top:-16px;">
                    <span style="position: absolute; left: 10px; font-weight: 700; top: 8px;">Parent's Contact : </span>
                    <input type="text" id="contactnumber" name="parentcontact" class="form-control" placeholder="Contact No." style="position: relative; left: 170px; width: 250px;">
                </div>
            </div>
