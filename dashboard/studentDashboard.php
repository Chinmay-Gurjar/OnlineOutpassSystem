...
<!--    Congrats Modal End-->
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
        ...
        <form class="text-center border border-light p-5" method="post" action="../connection/outpass-submit.php">
            ...
            <div class="form-row mb-4">
                ...
                <div class="col" style="top:20px;">
                    ...
                    <input type="date" id="date" name="date" class="form-control mb-4" placeholder="Date" style="position: relative; left: 120px; width: 250px;">                    
                </div>
                <div class="col" style="top:20px;">
                    <input type="text" id="contactnumber" name="contact" class="form-control" placeholder="Contact No." style="width:285px;">
                </div>
            </div>
